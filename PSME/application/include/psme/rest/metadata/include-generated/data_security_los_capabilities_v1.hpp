#ifndef PSME_REST_METADATA_DATA_SECURITY_LOS_CAPABILITIES_V1_HPP
#define PSME_REST_METADATA_DATA_SECURITY_LOS_CAPABILITIES_V1_HPP
...
static const std::string DataSecurityLoSCapabilities_v1_XML =
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="DataSecurityLoSCapabilities.v1_0_0">
      ...
      <EntityType Name="DataSecurityLoSCapabilities" BaseType="DataSecurityLoSCapabilities.DataSecurityLoSCapabilities">
        ...
        <NavigationProperty Name="SupportedLinesOfService" Type="Collection(DataSecurityLineOfService.DataSecurityLineOfService)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/ReadWrite"/>
...
#endif /* PSME_REST_METADATA_DATA_SECURITY_LOS_CAPABILITIES_V1_HPP */
