#ifndef PSME_REST_METADATA_DATA_PROTECTION_LINE_OFSERVICE_V1_HPP
#define PSME_REST_METADATA_DATA_PROTECTION_LINE_OFSERVICE_V1_HPP
...
static const std::string DataProtectionLineOfService_v1_XML =
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/Location_v1.xml">
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="DataProtectionLineOfService.v1_1_0">
      ...
      <Action Name="CreateReplicas" IsBound="true">
        ...
        <ReturnType Type="Collection(StorageReplicaInfo.ReplicaInfo)">
          <!-- <Annotation Term="OData.Description" String="The instance that represent the new replication relationships."/> <Annotation Term="OData.LongDescription" String="Each entry value shall represent the corresponding new replication relationship."/>
          -->
        </ReturnType>
...
#endif /* PSME_REST_METADATA_DATA_PROTECTION_LINE_OFSERVICE_V1_HPP */
